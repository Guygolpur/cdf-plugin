...
export var EuiCollapsibleNav = function EuiCollapsibleNav(_ref) {
  ...
  var _useState3 = useState(isWithinMinBreakpoint(typeof window === 'undefined' ? 0 : window.innerWidth, dockedBreakpoint)),
  ...
  var flyout = /*#__PURE__*/React.createElement(EuiFlyout, _extends({
    id: flyoutID,
