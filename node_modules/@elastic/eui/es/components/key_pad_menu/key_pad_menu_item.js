...
export var EuiKeyPadMenuItem = function EuiKeyPadMenuItem(_ref) {
  var id = _ref.id,
      ...
      rest = _objectWithoutProperties(_ref, ["id", "isSelected", "isDisabled", "label", "children", "className", "betaBadgeLabel", "betaBadgeTooltipContent", "betaBadgeIconType", "href", "rel", "target", "buttonRef", "checkable", "name", "value", "disabled", "onChange"]);
  ...
  var renderCheckableElement = function renderCheckableElement() {
    ...
    if (checkable === 'single') {
      checkableElement = /*#__PURE__*/React.createElement(EuiRadio, {
        id: itemId,
      ...
      checkableElement = /*#__PURE__*/React.createElement(EuiCheckbox, {
        id: itemId,
        className: inputClasses,
        checked: isSelected,
        disabled: isDisabled,
  ...
  var renderContent = function renderContent() {
    ...
    }, checkable ? renderCheckableElement() : renderBetaBadge(), /*#__PURE__*/React.createElement("span", {
