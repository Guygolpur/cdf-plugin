...
var EuiFlyout = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var flyoutContent = /*#__PURE__*/React.createElement(Element, _extends({}, rest, {
    role: role,
    className: classes,
    tabIndex: -1,
  ...
  var flyout = /*#__PURE__*/React.createElement(EuiFocusTrap, {
    disabled: isPushed,
  ...
  if (ownFocus && !isPushed) {
    flyout = /*#__PURE__*/React.createElement(EuiOverlayMask, _extends({
      onClick: onClose,
      headerZindexLocation: "below"
    }, maskProps), flyout);
  } else if (!isPushed) {
    // Otherwise still wrap within an EuiPortal so it appends (unless it is the push style)
    flyout = /*#__PURE__*/React.createElement(EuiPortal, null, flyout);
  }
