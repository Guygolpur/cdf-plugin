 ...
 */
import React, { createElement } from 'react'; // Importing seemingly unused types from `unified` because the definitions
    ...
    components: {
      ...
      code: function code(props) {
        return (// If there are linebreaks use codeblock, otherwise code
          /\r|\n/.exec(props.children) || props.className && props.className.indexOf(FENCED_CLASS) > -1 ? /*#__PURE__*/React.createElement(EuiCodeBlock, _extends({
            fontSize: "m",
            paddingSize: "s"
      ...
      blockquote: function blockquote(props) {
        return /*#__PURE__*/React.createElement("blockquote", _extends({}, props, {
      ...
      hr: function hr(props) {
        return /*#__PURE__*/React.createElement(EuiHorizontalRule, props);
      },
