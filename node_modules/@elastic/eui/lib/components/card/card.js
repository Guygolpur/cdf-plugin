...
var EuiCard = function EuiCard(_ref) {
  var className = _ref.className,
      ...
      rest = _objectWithoutProperties(_ref, ["className", "description", "isDisabled", "title", "titleElement", "titleSize", "icon", "image", "children", "footer", "onClick", "href", "rel", "target", "textAlign", "betaBadgeLabel", "betaBadgeTooltipContent", "betaBadgeTitle", "betaBadgeProps", "layout", "selectable", "display", "paddingSize"]);
  ...
  if (betaBadgeLabel) {
    ...
    }, /*#__PURE__*/_react.default.createElement(_beta_badge.EuiBetaBadge, _extends({
