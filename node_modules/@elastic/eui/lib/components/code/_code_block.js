...
var EuiCodeBlockImpl = function EuiCodeBlockImpl(_ref4) {
  var _ref4$transparentBack = _ref4.transparentBackground,
      ...
      rest = _objectWithoutProperties(_ref4, ["transparentBackground", "paddingSize", "fontSize", "isCopyable", "whiteSpace", "language", "inline", "children", "className", "overflowHeight", "isVirtualized"]);
  ...
  }, [fontSize]); // Used by `FixedSizeList` when `isVirtualized=true` or `children` is parsable (`isVirtualized=true`)
  ...
  var data = (0, _react.useMemo)(function () {
    ...
    return inline ? (0, _refractor.highlight)(children, language) : (0, _utils.highlightByLine)(children, language);
