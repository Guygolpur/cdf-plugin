...
var EuiFlyout = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var flyoutContent = /*#__PURE__*/_react.default.createElement(Element, _extends({}, rest, {
    role: role,
    className: classes,
    tabIndex: -1,
  ...
  var flyout = /*#__PURE__*/_react.default.createElement(_focus_trap.EuiFocusTrap, {
    disabled: isPushed,
    clickOutsideDisables: !ownFocus
  }, /*#__PURE__*/_react.default.createElement(_outside_click_detector.EuiOutsideClickDetector, {
    isDisabled: isPushed || !outsideClickCloses,
    onOutsideClick: function onOutsideClick() {
      return onClose();
    }
  }, flyoutContent)); // If ownFocus is set, wrap with an overlay and allow the user to click it to close it.


  if (ownFocus && !isPushed) {
    flyout = /*#__PURE__*/_react.default.createElement(_overlay_mask.EuiOverlayMask, _extends({
      onClick: onClose,
      headerZindexLocation: "below"
    }, maskProps), flyout);
  } else if (!isPushed) {
    // Otherwise still wrap within an EuiPortal so it appends (unless it is the push style)
    flyout = /*#__PURE__*/_react.default.createElement(_portal.EuiPortal, null, flyout);
  }
