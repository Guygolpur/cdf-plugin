...
.euiCodeBlock {
  ...
  .euiCodeBlock .euiCodeBlock__pre--isVirtualized {
    position: relative; }
...
.react-datepicker__navigation {
  ...
  .react-datepicker__navigation--previous {
    ...
    .react-datepicker__navigation--previous:focus {
      background-color: rgba(54, 162, 239, 0.2);
      box-shadow: 0 0 0 2px rgba(54, 162, 239, 0.2); }
...
.react-datepicker__year-option--preselected,
.react-datepicker__month-option--preselected {
  background: rgba(30, 151, 237, 0.2); }
...
.react-datepicker__month--accessible:focus {
  ...
  .react-datepicker__month--accessible:focus .react-datepicker__day--in-range:not(.react-datepicker__day--selected) {
    border-top-color: rgba(54, 162, 239, 0.2);
    border-bottom-color: rgba(54, 162, 239, 0.2); }
...
.euiDataGridRowCell--paddingSmall {
  padding: 4px; }
  .euiDataGridRowCell--paddingSmall .euiDataGridRowCell__contentByHeight + .euiDataGridRowCell__expandButton {
    padding: 0; }
...
.euiDataGridRowCell--paddingLarge {
  padding: 8px; }
  .euiDataGridRowCell--paddingLarge .euiDataGridRowCell__contentByHeight + .euiDataGridRowCell__expandButton {
    padding: 8px 0; }
...
.euiFacetButton {
  ...
  .euiFacetButton:focus {
    background-color: rgba(54, 162, 239, 0.2);
    box-shadow: -4px 0 rgba(54, 162, 239, 0.2), 4px 0 rgba(54, 162, 239, 0.2); }
...
.euiHeaderLogo {
  ...
  vertical-align: middle;
  white-space: nowrap; }
  .euiHeaderLogo:hover, .euiHeaderLogo:focus {
    text-decoration: underline; }
  .euiHeaderLogo:focus {
    outline: 2px solid currentColor;
    outline-offset: 2px;
...
.euiLink {
  text-align: left;
  font-weight: 500; }
  .euiLink:hover, .euiLink:focus {
    text-decoration: underline; }
  .euiLink:focus {
    outline: 2px solid currentColor;
    outline-offset: 2px;
    text-decoration-thickness: 2px !important; }
    .euiLink:focus:focus-visible {
      outline-style: auto; }
    .euiLink:focus:not(:focus-visible) {
      outline: none; }
  ...
  .euiLink.euiLink--subdued {
    color: #7a7f89; }
    .euiLink.euiLink--subdued:hover, .euiLink.euiLink--subdued:focus, .euiLink.euiLink--subdued:target {
      text-decoration: underline; }
  ...
  .euiLink.euiLink--primary {
    color: #36A2EF; }
    .euiLink.euiLink--primary:hover, .euiLink.euiLink--primary:focus, .euiLink.euiLink--primary:target {
      text-decoration: underline; }
  ...
  .euiLink.euiLink--secondary {
    color: #7DDED8; }
    .euiLink.euiLink--secondary:hover, .euiLink.euiLink--secondary:focus, .euiLink.euiLink--secondary:target {
      text-decoration: underline; }
    .euiLink.euiLink--secondary:target {
      color: #54d4cc; }
  ...
  .euiLink.euiLink--success {
    color: #7DDED8; }
    .euiLink.euiLink--success:hover, .euiLink.euiLink--success:focus, .euiLink.euiLink--success:target {
      text-decoration: underline; }
  ...
  .euiLink.euiLink--accent {
    color: #F68FBE; }
    .euiLink.euiLink--accent:hover, .euiLink.euiLink--accent:focus, .euiLink.euiLink--accent:target {
      text-decoration: underline; }
  ...
  .euiLink.euiLink--warning {
    color: #F3D371; }
    .euiLink.euiLink--warning:hover, .euiLink.euiLink--warning:focus, .euiLink.euiLink--warning:target {
      text-decoration: underline; }
  ...
  .euiLink.euiLink--danger {
    color: #F86B63; }
    .euiLink.euiLink--danger:hover, .euiLink.euiLink--danger:focus, .euiLink.euiLink--danger:target {
      text-decoration: underline; }
  ...
  .euiLink.euiLink--text {
    color: #DFE5EF; }
    .euiLink.euiLink--text:hover, .euiLink.euiLink--text:focus, .euiLink.euiLink--text:target {
      text-decoration: underline; }
  ...
  .euiLink.euiLink--ghost {
    color: #FFF; }
    .euiLink.euiLink--ghost:hover, .euiLink.euiLink--ghost:focus, .euiLink.euiLink--ghost:target {
      text-decoration: underline; }
...
.euiLoadingContent__singleLineBackground {
  ...
  width: 220%;
  height: 100%;
  background: linear-gradient(137deg, #2e3039 45%, #282a31 50%, #2e3039 55%); }
  @media screen and (prefers-reduced-motion: no-preference) {
    .euiLoadingContent__singleLineBackground {
...
.euiMarkdownFormat .euiTextColor--secondary .euiMarkdownFormat__table th,
.euiMarkdownFormat .euiTextColor--secondary .euiMarkdownFormat__table td {
  border-top: 1px solid #7DDED8;
  border-bottom: 1px solid #7DDED8; }
  .euiMarkdownFormat .euiTextColor--secondary .euiMarkdownFormat__table th:last-child,
  .euiMarkdownFormat .euiTextColor--secondary .euiMarkdownFormat__table td:last-child {
...
.euiText {
  ...
  .euiText blockquote:not(.euiMarkdownFormat__blockquote) {
    ...
    .euiText blockquote:not(.euiMarkdownFormat__blockquote) p:last-child {
      margin-bottom: 0; }
    .euiText blockquote:not(.euiMarkdownFormat__blockquote):before, .euiText blockquote:not(.euiMarkdownFormat__blockquote):after {
      position: absolute;
      content: '';
      height: 2px;
      width: 50%;
...
.euiButton--subdued {
  ...
  .euiButton--subdued:not([class*='isDisabled']):hover, .euiButton--subdued:not([class*='isDisabled']):focus {
    background-color: rgba(122, 127, 137, 0.2); }
  .euiButton--subdued.euiButton--fill:focus {
    outline-color: #FFF; }
  .euiButton--subdued.euiButton--fill:not([class*='isDisabled']) {
    color: #000; }
    .euiButton--subdued.euiButton--fill:not([class*='isDisabled']), .euiButton--subdued.euiButton--fill:not([class*='isDisabled']):hover, .euiButton--subdued.euiButton--fill:not([class*='isDisabled']):focus {
      background-color: #7a7f89; }
...
.euiButtonIcon--secondary:not(.euiButtonIcon--empty) {
  color: #7DDED8;
  background-color: rgba(125, 222, 216, 0.2); }
  .euiButtonIcon--secondary:not(.euiButtonIcon--empty):not([class*='isDisabled']):hover, .euiButtonIcon--secondary:not(.euiButtonIcon--empty):not([class*='isDisabled']):focus {
    background-color: rgba(125, 222, 216, 0.2); }
  .euiButtonIcon--secondary:not(.euiButtonIcon--empty).euiButtonIcon--fill:focus {
    outline-color: #FFF; }
  .euiButtonIcon--secondary:not(.euiButtonIcon--empty).euiButtonIcon--fill:not([class*='isDisabled']) {
    color: #000; }
    .euiButtonIcon--secondary:not(.euiButtonIcon--empty).euiButtonIcon--fill:not([class*='isDisabled']), .euiButtonIcon--secondary:not(.euiButtonIcon--empty).euiButtonIcon--fill:not([class*='isDisabled']):hover, .euiButtonIcon--secondary:not(.euiButtonIcon--empty).euiButtonIcon--fill:not([class*='isDisabled']):focus {
      background-color: #7DDED8; }
...
.euiButtonEmpty--subdued:enabled:focus {
  background-color: rgba(122, 127, 137, 0.2); }
...
.euiButtonGroup--medium .euiButtonGroupButton--subdued,
.euiButtonGroup--small .euiButtonGroupButton--subdued {
  color: #8d919a;
  background-color: rgba(122, 127, 137, 0.2); }
  .euiButtonGroup--medium .euiButtonGroupButton--subdued:not([class*='isDisabled']):hover, .euiButtonGroup--medium .euiButtonGroupButton--subdued:not([class*='isDisabled']):focus,
  .euiButtonGroup--small .euiButtonGroupButton--subdued:not([class*='isDisabled']):hover,
  .euiButtonGroup--small .euiButtonGroupButton--subdued:not([class*='isDisabled']):focus {
    background-color: rgba(122, 127, 137, 0.2); }
...
.euiButtonGroup--compressed .euiButtonGroupButton {
  ...
  .euiButtonGroup--compressed .euiButtonGroupButton--accent:not([class*='isDisabled']):focus:not(:focus-visible) {
    outline: none; }
  .euiButtonGroup--compressed .euiButtonGroupButton--secondary:not([class*='isDisabled']):focus, .euiButtonGroup--compressed .euiButtonGroupButton--secondary:not([class*='isDisabled']):focus-within {
    outline-color: #7DDED8; }
    .euiButtonGroup--compressed .euiButtonGroupButton--secondary:not([class*='isDisabled']):focus:focus-visible, .euiButtonGroup--compressed .euiButtonGroupButton--secondary:not([class*='isDisabled']):focus-within:focus-visible {
      outline-style: auto; }
  .euiButtonGroup--compressed .euiButtonGroupButton--secondary:not([class*='isDisabled']):focus:not(:focus-visible) {
    outline: none; }
  ...
  .euiButtonGroup--compressed .euiButtonGroupButton--danger:not([class*='isDisabled']):focus:not(:focus-visible) {
    outline: none; }
  .euiButtonGroup--compressed .euiButtonGroupButton--subdued:not([class*='isDisabled']):focus, .euiButtonGroup--compressed .euiButtonGroupButton--subdued:not([class*='isDisabled']):focus-within {
    outline-color: #7a7f89; }
    .euiButtonGroup--compressed .euiButtonGroupButton--subdued:not([class*='isDisabled']):focus:focus-visible, .euiButtonGroup--compressed .euiButtonGroupButton--subdued:not([class*='isDisabled']):focus-within:focus-visible {
      outline-style: auto; }
  .euiButtonGroup--compressed .euiButtonGroupButton--subdued:not([class*='isDisabled']):focus:not(:focus-visible) {
    outline: none; }
