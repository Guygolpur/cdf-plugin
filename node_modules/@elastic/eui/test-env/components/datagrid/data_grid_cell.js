...
var _row_height_utils = require("./row_height_utils");
...
var EuiDataGridCellContent = /*#__PURE__*/(0, _react.memo)(function (props) {
  var renderCellValue = props.renderCellValue,
      column = props.column,
      setCellContentsRef = props.setCellContentsRef,
      rowHeightsOptions = props.rowHeightsOptions,
      rowIndex = props.rowIndex,
      colIndex = props.colIndex,
      rest = (0, _objectWithoutProperties2.default)(props, ["renderCellValue", "column", "setCellContentsRef", "rowHeightsOptions", "rowIndex", "colIndex"]); // React is more permissible than the TS types indicate
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    style: rowHeightsOptions ? (0, _row_height_utils.getStylesForCell)(rowHeightsOptions, rowIndex) : {},
    className: !rowHeightsOptions ? 'euiDataGridRowCell__truncate' : ''
  }, /*#__PURE__*/_react.default.createElement(CellElement, (0, _extends2.default)({
    isDetails: false,
    "data-test-subj": "cell-content",
    rowIndex: rowIndex
  }, rest)), screenReaderPosition);
...
EuiDataGridCellContent.propTypes = {
  ...
  rowHeightsOptions: _propTypes.default.shape({
    /**
       ...
       */
    defaultHeight: _propTypes.default.oneOfType([_propTypes.default.number.isRequired, _propTypes.default.shape({
...
var EuiDataGridCell = /*#__PURE__*/function (_Component) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onFocus", function (e) {
      ...
      if (_this.cellRef.current === e.target) {
        var _this$props = _this.props,
            ...
            isExpandable = _this$props.isExpandable; // focus in next tick to give potential focus capturing mechanisms time to release their traps
  ...
  (0, _createClass2.default)(EuiDataGridCell, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if (nextState.disableCellTabIndex !== this.state.disableCellTabIndex) return true; // check if we should update cell because height was changed

      if (this.cellRef.current && nextProps.getRowHeight) {
        if (this.cellRef.current.offsetHeight && this.cellRef.current.offsetHeight !== nextProps.getRowHeight(nextProps.rowIndex)) {
          return true;
        }
      }
    ...
    value: function render() {
      ...
      var anchorClass = (0, _classnames.default)('euiDataGridRowCell__expandFlex', {
        euiDataGridRowCell__alignBaseLine: this.props.rowHeightsOptions
      });
      var expandClass = this.props.rowHeightsOptions ? 'euiDataGridRowCell__contentByHeight' : 'euiDataGridRowCell__expandContent';
      ...
      var anchorContent = /*#__PURE__*/_react.default.createElement(_focus_trap.EuiFocusTrap, {
        ...
        style: this.props.rowHeightsOptions ? {
          height: '100%'
        } : {},
      ...
      if (isExpandable || column && column.cellActions) {
        if (showCellButtons) {
          anchorContent = /*#__PURE__*/_react.default.createElement("div", {
            ...
            className: expandClass
          }, /*#__PURE__*/_react.default.createElement(EuiDataGridCellContent, cellContentProps)), /*#__PURE__*/_react.default.createElement(_data_grid_cell_buttons.EuiDataGridCellButtons, {
            rowIndex: rowIndex,
            column: column,
      ...
      if (isExpandable || column && column.cellActions) {
        if (this.state.popoverIsOpen) {
          innerContent = /*#__PURE__*/_react.default.createElement("div", {
            className: this.props.rowHeightsOptions ? 'euiDataGridRowCell__contentByHeight' : 'euiDataGridRowCell__content'
