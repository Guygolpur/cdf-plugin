    ...
    components: {
      ...
      code: function code(props) {
        return (// If there are linebreaks use codeblock, otherwise code
          /\r|\n/.exec(props.children) || props.className && props.className.indexOf(_remark_prismjs.FENCED_CLASS) > -1 ? /*#__PURE__*/_react.default.createElement(_code.EuiCodeBlock, (0, _extends2.default)({
            fontSize: "m",
            paddingSize: "s"
      ...
      blockquote: function blockquote(props) {
        return /*#__PURE__*/_react.default.createElement("blockquote", (0, _extends2.default)({}, props, {
      ...
      hr: function hr(props) {
        return /*#__PURE__*/_react.default.createElement(_horizontal_rule.EuiHorizontalRule, props);
      },
