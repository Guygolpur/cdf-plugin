...
var EuiBetaBadge = function EuiBetaBadge(_ref) {
  ...
  if (onClick || href) {
    content = /*#__PURE__*/_react.default.createElement(Element, (0, _extends2.default)({
    ...
    if (tooltipContent) {
      return /*#__PURE__*/_react.default.createElement(_tool_tip.EuiToolTip, {
        ...
        title: title || label
      }, /*#__PURE__*/_react.default.createElement(_react.Fragment, null, content));
    } else {
      return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, content);
    }
  } else {
    if (tooltipContent) {
      return /*#__PURE__*/_react.default.createElement(_tool_tip.EuiToolTip, {
