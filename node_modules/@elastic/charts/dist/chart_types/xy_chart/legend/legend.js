...
function getPointStyle(spec, theme) {
    var _a, _b, _c;
    var mergeOptions = { mergeOptionalPartialValues: true };
    if (specs_1.isBubbleSeriesSpec(spec)) {
        return common_1.mergePartial(theme.bubbleSeriesStyle.point, (_a = spec.bubbleSeriesStyle) === null || _a === void 0 ? void 0 : _a.point, mergeOptions);
    }
    else if (specs_1.isLineSeriesSpec(spec)) {
        return common_1.mergePartial(theme.lineSeriesStyle.point, (_b = spec.lineSeriesStyle) === null || _b === void 0 ? void 0 : _b.point, mergeOptions);
    }
    else if (specs_1.isAreaSeriesSpec(spec)) {
        return common_1.mergePartial(theme.areaSeriesStyle.point, (_c = spec.areaSeriesStyle) === null || _c === void 0 ? void 0 : _c.point, mergeOptions);
    }
}
function computeLegend(dataSeries, lastValues, seriesColors, specs, axesSpecs, showLegendExtra, serialIdentifierDataSeriesMap, deselectedDataSeries, theme, sortSeriesBy) {
