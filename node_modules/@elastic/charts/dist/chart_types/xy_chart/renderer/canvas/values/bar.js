...
function renderBarValues(ctx, props) {
    ...
    var _loop_1 = function (i) {
        ...
        var text = displayValue.text, fontSize = displayValue.fontSize, fontScale = displayValue.fontScale, overflowConstraints = displayValue.overflowConstraints, isValueContainedInElement = displayValue.isValueContainedInElement;
        var textLines = {
            lines: [text],
        ...
        var _a = positionText(bars[i], displayValue, rotation, barSeriesStyle.displayValue, alignment), x = _a.x, y = _a.y, align = _a.align, baseline = _a.baseline, rect = _a.rect, overflow = _a.overflow;
