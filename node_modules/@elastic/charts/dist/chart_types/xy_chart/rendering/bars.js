...
function renderBars(orderIndex, dataSeries, xScale, yScale, panel, color, sharedSeriesStyle, displayValueSettings, styleAccessor, minBarHeight, stackMode, chartRotation) {
    ...
    dataSeries.data.forEach(function (datum) {
        ...
        var height = common_1.isNil(y0Scaled) || common_1.isNil(y) ? 0 : y0Scaled - y;
        if (common_1.isNil(y0Scaled) || common_1.isNil(y)) {
            y = 0;
        }
        ...
        var originalY1Value = stackMode === specs_1.StackMode.Percentage ? (common_1.isNil(y1) ? null : y1 - (y0 !== null && y0 !== void 0 ? y0 : 0)) : initialY1;
        var formattedDisplayValue = (_d = displayValueSettings === null || displayValueSettings === void 0 ? void 0 : displayValueSettings.valueFormatter) === null || _d === void 0 ? void 0 : _d.call(displayValueSettings, originalY1Value);
        ...
        var _g = computeBoxWidth(displayValueText !== null && displayValueText !== void 0 ? displayValueText : '', { padding: padding, fontSize: fontSize, fontFamily: fontFamily, bboxCalculator: bboxCalculator, width: width }, displayValueSettings), displayValueWidth = _g.displayValueWidth, fixedFontScale = _g.fixedFontScale;
