 ...
 * @public
 */
export declare const getRadians: (angle: number) => number;
/**
...
/** @public */
export declare type ValueAccessor = (d: Datum) => AdditiveNumber;
/** @public */
export declare type LabelAccessor = (value: PrimitiveValue) => string;
/** @public */
