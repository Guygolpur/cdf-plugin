...
/** @alpha */
export declare type SmallMultiplesProps = Partial<Omit<SmallMultiplesSpec, 'chatType' | 'specType'>>;
/** @alpha */
export declare const SmallMultiples: React.FunctionComponent<SmallMultiplesProps>;
