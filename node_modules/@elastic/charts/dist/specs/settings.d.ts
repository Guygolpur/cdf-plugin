...
import { Color, HorizontalAlignment, LayoutDirection, Position, Rendering, Rotation, VerticalAlignment } from '../utils/common';
import { GeometryValue } from '../utils/geometry';
import { GroupId } from '../utils/ids';
import { SeriesCompareFn } from '../utils/series_sort';
import { PartialTheme, Theme } from '../utils/themes/theme';
import { BinAgg, BrushAxis, Direction, PointerEventType, PointerUpdateTrigger, TooltipType } from './constants';
/** @public */
...
/** @public */
export declare type ElementClickListener = (elements: Array<XYChartElementEvent | PartitionElementEvent | HeatmapElementEvent | WordCloudElementEvent>) => void;
/** @public */
export declare type ElementOverListener = (elements: Array<XYChartElementEvent | PartitionElementEvent | HeatmapElementEvent | WordCloudElementEvent>) => void;
/** @public */
export declare type BrushEndListener = (brushArea: XYBrushArea) => void;
/** @public */
 ...
 * @public
 */
export declare type TooltipProps = TooltipPortalSettings<'chart'> & {
    /**
