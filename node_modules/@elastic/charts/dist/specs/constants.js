...
exports.DEFAULT_SETTINGS_SPEC = exports.DEFAULT_TOOLTIP_CONFIG = exports.DEFAULT_LEGEND_CONFIG = exports.DEFAULT_TOOLTIP_SNAP = exports.DEFAULT_TOOLTIP_TYPE = exports.TooltipStickTo = exports.PointerUpdateTrigger = exports.BrushAxis = exports.TooltipType = exports.PointerEventType = exports.Direction = exports.BinAgg = exports.SpecType = void 0;
...
exports.DEFAULT_SETTINGS_SPEC = __assign({ id: '__global__settings___', chartType: chart_types_1.ChartType.Global, specType: exports.SpecType.Settings, rendering: 'canvas', rotation: 0, animateData: true, resizeDebounce: 10, debug: false, tooltip: exports.DEFAULT_TOOLTIP_CONFIG, pointerUpdateTrigger: exports.PointerUpdateTrigger.X, externalPointerEvents: {
        tooltip: {
            visible: false,
        },
    }, hideDuplicateAxes: false, baseTheme: light_theme_1.LIGHT_THEME, brushAxis: exports.BrushAxis.X, minBrushDelta: 2, ariaUseDefaultSummary: true, ariaLabelHeadingLevel: 'p' }, exports.DEFAULT_LEGEND_CONFIG);
